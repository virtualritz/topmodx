...
public:
	...
	QCheckBox      *cubicalTriangulateNewFacesCheckBox;
	QCheckBox      *cubicalScherkCollinsCheckBox;
	QDoubleSpinBox *cubicalPinchSpinBox;
	QDoubleSpinBox *cubicalPinchCenterSpinBox;
	QDoubleSpinBox *cubicalPinchWidthSpinBox;
...
public slots:
	...
	void toggleCubicalTriangulateFace(int state);
