...
QTabWidget  *mPrefTabs;
  ...
  QWidget *mColorsTab;
      ...
      //face area selection tolerance and valence-2 split offset settings:
      //dave
      QDoubleSpinBox *face_area_tolerance_spin_,*valence_2_split_offeset_spin_;
      QLabel *face_area_tolerance_label_, *valence_2_split_offset_label_;
      float valence_2_split_offset_,valence_2_split_offset_default_,face_area_tolerance_,face_area_tolerance_default_;
