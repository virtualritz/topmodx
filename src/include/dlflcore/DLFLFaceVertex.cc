...
namespace DLFL {
  ...
  NextOnFreeList *DLFLFaceVertex::face_pool = NULL;
  ...
  void DLFLFaceVertex::setDS2Coord0(const Vector3d& dsc0) {
    if(!ds2coords) {
      ds2coords = new Vector3d[4];
    }
    ds2coords[0] = dsc0; 
