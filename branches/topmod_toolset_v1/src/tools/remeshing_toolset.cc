...
#include "remeshing_toolset.h"

/*!
	\ingroup gui
	@{

	\class RemeshingToolset
...
RemeshingToolset::RemeshingToolset(QWidget *parent, QShortcutManager *sm, QWidget *actionList)
		: QWidget(parent)
{
	setParent(0);
	parent_ = parent;

	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Dual);
...
QMenu* RemeshingToolset::getMenu(){
...
void RemeshingToolset::addActions(QActionGroup *actionGroup, QToolBar *toolBar, QStackedWidget *stackedWidget){
...
QDoubleSpinBox *RemeshingToolset::createDoubleSpinBox(QGridLayout *layout, QLabel *label, QString s, double low, double high, double step, double value, double decimals, int row, int col){
...
void RemeshingToolset::setupDual(){
	...
	connect(dualFasterCheckBox, SIGNAL(stateChanged(int)), ((MainWindow*)parent_),SLOT(toggleAccurateDualFlag(int)) );
	mDualLayout->addWidget(dualFasterCheckBox,0,0);
	//create crust button
	dualCreateButton = new QPushButton(tr("Create Dual"), this);
	connect(dualCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerDual(){

	((MainWindow*)parent_)->setToolOptions(mDualWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Dual);
}

void RemeshingToolset::setupThreeConversion(){
	...
	connect(rootThreeCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(triangulateCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualVertexTruncationButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(stellationButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(starSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeStarOffset(double)) );
	//create button
	starButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(starButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(twelveSixFourSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeSubStellateCurve(double)) );
	//create button
	twelveSixFourButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(twelveSixFourButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(honeycombButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(vertexTruncationSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeVertexCuttingOffset(double)) );
	vertexTruncationButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(vertexTruncationButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualTwelveSixFourSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeDual1264Scale(double)) );
	//create button
	dualTwelveSixFourButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(dualTwelveSixFourButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerRootThree(){

	((MainWindow*)parent_)->setToolOptions(mRootThreeWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Root3);
}

void RemeshingToolset::triggerTriangulate(){

	((MainWindow*)parent_)->setToolOptions(mTriangulateWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Triangulate);
}

void RemeshingToolset::triggerDualVertexTruncation(){

	((MainWindow*)parent_)->setToolOptions(mDualVertexTruncationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualVertexTrunc);
}

void RemeshingToolset::triggerStellation(){

	((MainWindow*)parent_)->setToolOptions(mStellationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::GlobalStellate);
}

void RemeshingToolset::triggerDoubleStellation(){

	((MainWindow*)parent_)->setToolOptions(mDoubleStellationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Star);
}

void RemeshingToolset::triggerTwelveSixFour(){

	((MainWindow*)parent_)->setToolOptions(mTwelveSixFourWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Generic1264);
}

void RemeshingToolset::triggerHoneycomb(){

	((MainWindow*)parent_)->setToolOptions(mHoneycombWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Honeycomb);
}

void RemeshingToolset::triggerVertexTruncation(){

	((MainWindow*)parent_)->setToolOptions(mVertexTruncationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::VertexTrunc);
}

void RemeshingToolset::triggerDualTwelveSixFour(){

	((MainWindow*)parent_)->setToolOptions(mDualTwelveSixFourWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualGeneric1264);
}

void RemeshingToolset::setupFourConversion(){
  ...
  mSimplestWidget = new QWidget;
	...
	connect(linearVertexCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(catmullClarkCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(stellateEdgeRemovalCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dooSabinCheckBox, SIGNAL(stateChanged(int)), ((MainWindow*)parent_),SLOT(toggleDooSabinEdgeFlag(int)) );
	dooSabinCreateButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(dooSabinCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(cornerCuttingAlphaSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeCornerCuttingAlpha(double)) );
	cornerCuttingCreateButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(cornerCuttingCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(modifiedCornerCuttingSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeModifiedCornerCuttingThickness(double)) );
	modifiedCornerCuttingCreateButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(modifiedCornerCuttingCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(simplestCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerLinearVertex(){

	((MainWindow*)parent_)->setToolOptions(mLinearVertexWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::LinearVertexInsertion);
}

void RemeshingToolset::triggerCatmullClark(){

	((MainWindow*)parent_)->setToolOptions(mCatmullClarkWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::CatmullClark);
}

void RemeshingToolset::triggerStellateEdgeRemoval(){

	((MainWindow*)parent_)->setToolOptions(mStellateEdgeRemovalWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::ModifiedStellate);
}

void RemeshingToolset::triggerDooSabin(){

	((MainWindow*)parent_)->setToolOptions(mDooSabinWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DooSabin);
}

void RemeshingToolset::triggerCornerCutting(){

	((MainWindow*)parent_)->setToolOptions(mCornerCuttingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::CornerCutting);
}

void RemeshingToolset::triggerModifiedCornerCutting(){

	((MainWindow*)parent_)->setToolOptions(mModifiedCornerCuttingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::ModifiedCornerCutting);
}

void RemeshingToolset::triggerSimplest(){

	((MainWindow*)parent_)->setToolOptions(mSimplestWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Simplest);
}

void RemeshingToolset::setupFiveConversion(){
  ...
  mDualPentagonalizationWidget = new QWidget;
	...
	connect(pentagonalizationSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changePentagonalOffset(double)) );
	//button
	pentagonalizationCreateButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(pentagonalizationCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(cubicPentagonalizationSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changePentagonalOffset(double)) );
	cubicPentagonalizationCreateButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(cubicPentagonalizationCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualPentagonalizationCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerPentagonalization(){

	((MainWindow*)parent_)->setToolOptions(mPentagonalizationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Pentagonal);
}

void RemeshingToolset::triggerCubicPentagonalization(){

	((MainWindow*)parent_)->setToolOptions(mCubicPentagonalizationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::CubicPentagonal);
}

void RemeshingToolset::triggerDualPentagonalization(){

	((MainWindow*)parent_)->setToolOptions(mDualPentagonalizationWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualPentagonal);
}

void RemeshingToolset::setupThreePreservation(){
  ...
  mDualLoopSubdivisionWidget = new QWidget;
	...
	connect(loopStyleRemeshingSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeLoopStyleSubdivisionLength(double)) );
	loopStyleRemeshingButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(loopStyleRemeshingButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(loopSubdivisionCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualLoopStyleRemeshingTwistSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeRoot4Twist(double)) );
	...
	connect(dualLoopStyleRemeshingWeightSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeRoot4Weight(double)) );
	dualLoopStyleRemeshingButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(dualLoopStyleRemeshingButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualLoopSubdivisionCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerLoopStyleRemeshing(){

	((MainWindow*)parent_)->setToolOptions(mLoopStyleRemeshingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::LoopStyle);
}

void RemeshingToolset::triggerLoopSubdivision(){

	((MainWindow*)parent_)->setToolOptions(mLoopSubdivisionWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Loop);
}

void RemeshingToolset::triggerDualLoopStyleRemeshing(){

	((MainWindow*)parent_)->setToolOptions(mDualLoopStyleRemeshingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Root4);
}

void RemeshingToolset::triggerDualLoopSubdivision(){

	((MainWindow*)parent_)->setToolOptions(mDualLoopSubdivisionWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualLoop);
}

void RemeshingToolset::setupFourPreservation(){
  ...
  mDualCheckerboardWidget = new QWidget;
	...
	connect(globalExtrudeButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(checkerboardCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualGlobalExtrudeButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualCheckerboardCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerGlobalExtrude(){

	((MainWindow*)parent_)->setToolOptions(mGlobalExtrudeWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::GlobalCubicExtrude);
}

void RemeshingToolset::triggerCheckerboard(){

	((MainWindow*)parent_)->setToolOptions(mCheckerboardWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::CheckerBoard);
}

void RemeshingToolset::triggerDualGlobalExtrude(){

	((MainWindow*)parent_)->setToolOptions(mDualGlobalExtrudeWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualGlobalCubicExtrude);
}

void RemeshingToolset::triggerDualCheckerboard(){

	((MainWindow*)parent_)->setToolOptions(mDualCheckerboardWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualCheckerBoard);
}

void RemeshingToolset::setupFivePreservation(){
  ...
  mDualPentagonPreservingWidget = new QWidget;
	...
	connect(pentagonPreservingSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changePentagonalScaleFactor(double)) );
	pentagonPreservingButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(pentagonPreservingButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dualPentagonPreservingCreateButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerPentagonPreserving(){

	((MainWindow*)parent_)->setToolOptions(mPentagonPreservingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::PentagonPreserving);
}

void RemeshingToolset::triggerDualPentagonPreserving(){

	((MainWindow*)parent_)->setToolOptions(mDualPentagonPreservingWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualPentagonPreserving);
}

void RemeshingToolset::setupSixPreservation(){
  ...
  mLoopStyleRemeshingSixWidget = new QWidget;
	...
	connect(dualLoopStyleRemeshingSixTwistSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeRoot4Twist(double)) );
	...
	connect(dualLoopStyleRemeshingSixWeightSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeRoot4Weight(double)) );
	dualLoopStyleRemeshingSixButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(dualLoopStyleRemeshingSixButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(loopStyleRemeshingSixSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeLoopStyleSubdivisionLength(double)) );
	loopStyleRemeshingSixButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(loopStyleRemeshingSixButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
...
void RemeshingToolset::triggerDualLoopStyleRemeshingSix(){
	((MainWindow*)parent_)->setToolOptions(mDualLoopStyleRemeshingSixWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::HexagonPreserving);
}

void RemeshingToolset::triggerLoopStyleRemeshingSix(){
	((MainWindow*)parent_)->setToolOptions(mLoopStyleRemeshingSixWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DualHexagonPreserving);
}

void RemeshingToolset::setupMiscellaneous(){
  ...
  mSubdivideFaceWidget = new QWidget;
	...
	connect(fractalMultiplierSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeFractalOffset(double)) );
	fractalButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(fractalButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(doubleStellateMiscHeightSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeSubStellateAmount(double)) );
	...
	connect(doubleStellateMiscCurveSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeSubStellateCurve(double)) );
	doubleStellateMiscButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(doubleStellateMiscButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dooSabinBCButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(dooSabinBCNewScaleSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeDooSabinBCnewScale(double)) );
	...
	connect(dooSabinBCNewLengthSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeDooSabinBCnewLength(double)) );
	dooSabinBCNewButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(dooSabinBCNewButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(domeHeightSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeDomeSubdivisionLength(double)) );
	...
	connect(domeScaleSpinBox, SIGNAL(valueChanged(double)), ((MainWindow*)parent_),SLOT(changeDomeSubdivisionScale(double)) );
	domeButton = new QPushButton(tr("Perform Remeshing"), this);
	connect(domeButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(performRemeshing()) );
	...
	connect(subdivideFaceCheckBox, SIGNAL(stateChanged(int)), ((MainWindow*)parent_),SLOT(toggleUseQuadsFlag(int)) );
	...
	connect(subdivideFaceButton, SIGNAL(clicked()), ((MainWindow*)parent_),SLOT(subdivideSelectedFaces()) );
...
void RemeshingToolset::triggerFractal(){

	((MainWindow*)parent_)->setToolOptions(mFractalWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Fractal);
}

void RemeshingToolset::triggerDoubleStellateMisc(){

	((MainWindow*)parent_)->setToolOptions(mDoubleStellateMiscWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::ModifiedDoubleStellate);
}

void RemeshingToolset::triggerDooSabinBC(){

	((MainWindow*)parent_)->setToolOptions(mDooSabinBCWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DooSabinBC);
}

void RemeshingToolset::triggerDooSabinBCNew(){

	((MainWindow*)parent_)->setToolOptions(mDooSabinBCNewWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::DooSabinBCNew);
}

void RemeshingToolset::triggerDome(){

	((MainWindow*)parent_)->setToolOptions(mDomeWidget);
	((MainWindow*)parent_)->setRemeshingScheme(MainWindow::Dome);
}

void RemeshingToolset::triggerSubdivideFace(){

	((MainWindow*)parent_)->setToolOptions(mSubdivideFaceWidget);
	((MainWindow*)parent_)->setMode(MainWindow::SubdivideFace);
}

void RemeshingToolset::retranslateUi(){
	//actions and menus
	...
	// widgets and stuff
	//!< \todo add buttons and spinbox labels to retranslate function for remeshing_toolset.cc .. .done i think... dave
